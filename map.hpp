...
namespace ft
{
	...
	public:
		explicit map(const key_compare &comp = key_compare(), const allocator_type &alloc = allocator_type()): _rbTree(), _alloc(alloc), _compare(comp), _value_compare(value_compare()){}
